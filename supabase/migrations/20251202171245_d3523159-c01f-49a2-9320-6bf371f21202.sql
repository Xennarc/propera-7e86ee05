-- Add columns for tracking PIN metadata
ALTER TABLE public.guests 
ADD COLUMN IF NOT EXISTS portal_pin_last4 text,
ADD COLUMN IF NOT EXISTS portal_pin_set_at timestamp with time zone;

-- Create function to generate and set guest PIN
