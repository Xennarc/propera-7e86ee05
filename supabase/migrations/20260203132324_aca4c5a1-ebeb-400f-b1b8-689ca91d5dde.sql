-- Phase A: Fix enum issues and create atomic RPCs for dispatch
-- Drop existing function first due to return type change

-- ============================================================================
-- A1: Drop and recreate add_request_to_trip with correct enums
-- ============================================================================
DROP FUNCTION IF EXISTS public.add_request_to_trip(uuid, uuid);
...
-- ============================================================================
-- A2: Create rpc_transport_attach_requests_to_trip (batch atomic attach)
-- ============================================================================
...
GRANT EXECUTE ON FUNCTION public.add_request_to_trip(uuid, uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION public.rpc_transport_attach_requests_to_trip(uuid, uuid, uuid[]) TO authenticated;
GRANT EXECUTE ON FUNCTION public.rpc_transport_cancel_empty_trip(uuid, uuid) TO authenticated;