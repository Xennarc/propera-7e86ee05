...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompts: Record<string, string> = {
      ...
      sales: "You are a revenue management and operations consultant for a luxury Maldivian resort. Analyze revenue KPIs, attach rates, channel performance, booking source attribution (normal, pre-arrival, in-stay upsell), and cancellation patterns. Provide: (1) 3-5 key observations about current performance with specific numbers, including the effectiveness of pre-arrival planning and in-stay suggestions if applicable, and (2) 5-7 PRACTICAL, CONCRETE actions the resort could test to improve sales next month. Focus on pricing strategies, package creation, upselling tactics, scheduling optimization, targeting high-value segments, optimizing pre-arrival communication, enhancing in-stay suggestions, and reducing cancellations. Be specific—avoid generic advice. Use the data to support your recommendations.",
    };
