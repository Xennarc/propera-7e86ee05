 ...
 * Badges are clickable deep links. Long-press / ⋯ opens QuickActionsDrawer.
 */
...
import { OpsQuickActionsDrawer } from './OpsQuickActionsDrawer';
import {
  Ship,
  Users,
  Anchor,
  ...
  return (
    <>
      <div
        ...
        className={cn(
          'w-full text-left rounded-2xl border border-border/40 bg-card p-4 space-y-3 transition-colors hover:bg-accent/5 min-h-[104px] cursor-pointer',
          hasConflicts && 'border-warning/40',
        )}
      >
        {/* Header: time + name + status + actions */}
