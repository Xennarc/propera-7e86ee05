    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          // 44px touch target for nav buttons
          "h-11 w-11 bg-transparent p-0 hover:bg-muted transition-colors",
        ),
        nav_button_previous: "absolute left-1",
        nav_button_next: "absolute right-1",
        table: "w-full border-collapse space-y-1",
        head_row: "flex",
        // 44px width cells for touch
        head_cell: "text-muted-foreground rounded-md w-11 font-medium text-xs",
        row: "flex w-full mt-2",
        // 44px × 44px cells for touch
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-11 w-11 p-0 font-normal aria-selected:opacity-100 transition-colors"),
