...
import { Check, ArrowRight, Smartphone, Monitor, BarChart3, Users, Sparkles, Crown } from 'lucide-react';
...
const PLAN_CONFIG: Record<string, { icon: typeof Smartphone; gradient: string; accent: string }> = {
  essential: { 
    icon: Smartphone, 
