  ...
  const navGroups: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { title: 'Ops Inbox', url: '/staff/activities/ops', icon: Activity, roles: ['RESORT_ADMIN', 'MANAGER', 'FRONT_OFFICE', 'ACTIVITIES'], requiredFlags: ['enable_activities_ops'] },
        { title: 'Day Sheet', url: '/staff/activities/ops/day', icon: ClipboardList, roles: ['RESORT_ADMIN', 'MANAGER', 'FRONT_OFFICE', 'ACTIVITIES'], requiredFlags: ['enable_activities_ops'] },
