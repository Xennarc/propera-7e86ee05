...
const ModuleCard = memo(function ModuleCard({
  ...
  return (
    <motion.div
      ...
      className="group relative bg-background/50 backdrop-blur-sm rounded-xl border border-border/50 p-6 hover:border-primary/30 hover:bg-background/80 transition-all duration-300 motion-safe:hover:-translate-y-1 will-change-transform cursor-pointer"
    >
      {/* Glass effect */}
      <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-xl" />
      
      <div className="relative flex items-start gap-4">
        <div className="w-12 h-12 rounded-xl bg-muted/50 flex items-center justify-center text-muted-foreground group-hover:bg-primary/10 group-hover:text-primary transition-colors shrink-0">
