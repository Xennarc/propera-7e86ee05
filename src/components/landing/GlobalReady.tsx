...
export function GlobalReady() {
  ...
  return (
    <section className="py-24 bg-background relative overflow-hidden atlas-texture">
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-primary/3 dark:bg-primary/8 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-teal-400/3 dark:bg-teal-400/8 rounded-full blur-[80px] pointer-events-none" />
