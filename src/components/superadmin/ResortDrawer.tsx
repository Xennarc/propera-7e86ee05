...
export function ResortDrawer({ resort, open, onOpenChange }: ResortDrawerProps) {
            ...
            <TabsContent value="settings" className="space-y-4 mt-0">
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-muted/30 rounded-xl">
                  <div>
                    <Label>Activities Module</Label>
                    <p className="text-xs text-muted-foreground">Enable activity booking</p>
                  </div>
                  <Switch checked disabled />
                </div>
                <div className="flex items-center justify-between p-4 bg-muted/30 rounded-xl">
                  <div>
                    <Label>Dining Module</Label>
                    <p className="text-xs text-muted-foreground">Enable restaurant reservations</p>
                  </div>
                  <Switch checked disabled />
                </div>
                <div className="flex items-center justify-between p-4 bg-muted/30 rounded-xl">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Guest pre-arrival forms</p>
                  </div>
                  <Switch checked disabled />
                </div>
                <div className="flex items-center justify-between p-4 bg-muted/30 rounded-xl">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Rewards and tiers</p>
                  </div>
                  <Switch disabled />
                </div>
              </div>
              <p className="text-xs text-muted-foreground text-center">
                Use the Feature Flags page to toggle modules
              </p>
            </TabsContent>
