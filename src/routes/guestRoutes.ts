...
export const GUEST_ROUTES = {
  ...
  ROOM_SERVICE: '/guest/room-service',
  ROOM_SERVICE_CART: '/guest/room-service/cart',
  ROOM_SERVICE_ORDERS: '/guest/room-service/orders',
  ROOM_SERVICE_ORDER_DETAIL: '/guest/room-service/orders/:orderId',
