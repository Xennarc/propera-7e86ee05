...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      'AI Revenue Coach with actionable recommendations',
      'Sales performance & revenue attribution',
      'Guest segment analysis & behaviour insights',
      'Booking source ROI tracking',
      'Occupancy & utilisation trends',
      'Cancellation pattern analysis',
      'Guest loyalty program with tiers & rewards',
      'Booking health diagnostics',
      'Dedicated success management',
    ],
    whoItsFor: 'For data-driven resort leaders who want AI insights to maximise revenue and guest loyalty to drive repeat bookings.',
    problemSolved: 'Stop guessing. Get AI-powered recommendations that identify exactly where to focus – which activities to promote, when to adjust pricing, and how to reduce cancellations.',
    details: {
      guestExperience: [
        'Personalised loyalty tier with exclusive perks',
        'Earn and track points on every booking',
        'Progress visibility toward next tier',
        'Redeem rewards during stay',
      ],
      staffOperations: [
        'AI Revenue Coach on every report page',
        'Configure loyalty program and custom tiers',
        'Set category-specific earn rules',
        'Manage member points and tier upgrades',
        'Booking health diagnostics',
      ],
      analytics: [
        'AI-generated insights with specific action items',
        'Revenue breakdown by source (pre-arrival vs in-stay)',
        'Activity & restaurant revenue per guest',
        'Guest segment performance (by nationality, channel)',
        'Cancellation loss analysis with trends',
        'Attach rate & capture rate tracking',
        'Occupancy trends by outlet and time',
      ],
      support: [
        'Dedicated onboarding and success manager',
        'Quarterly business reviews',
        'Best-practice guidance for revenue optimisation',
      ],
    },
  },
];
